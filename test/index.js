const Credstash = require("../index.js").default;
...
var mockKMS = (params, done) => {
  var ret = {
    Plaintext: new Buffer(
      "KvQ7FPrc2uYXHjW8n+Y63HHCvyRjujeaIZepV/eUkfkz8ZbM9oymmzC69+XLTlbtvRV1MNmo3ngqE+7dJHoDMw==",
      "base64"
    )
  };
      ...
      Items: [
        {
          ...
          key: {
            S:
              ""
          },
          hmac: {
            S:
              "ada335c27410033b16887d083aba629c17ad8f88b7982f331e4f6f8df92c41a9"
          },
          contents: {
            S: "H2T+k+c="
          }
